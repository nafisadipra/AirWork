...
- **[COMPLETE-IMPLEMENTATION-GUIDE.md](./COMPLETE-IMPLEMENTATION-GUIDE.md)** - Full implementation details
- **[SECURITY-AUDIT-CHECKLIST.md](./SECURITY-AUDIT-CHECKLIST.md)** - Comprehensive security testing
- **[ARCHITECTURE.md](./docs/ARCHITECTURE.md)** - System architecture deep-dive
- **[API.md](./docs/API.md)** - IPC API documentation
...
```bash
npm run build:mac
# Output: release/SecureCollab-1.0.0.dmg
...
```bash
npm run build:win
# Output: release/SecureCollab-Setup-1.0.0.exe
...
npm run build:linux
# Output: 
#   release/SecureCollab-1.0.0.AppImage
#   release/SecureCollab-1.0.0.deb
#   release/SecureCollab-1.0.0.rpm
```
...
| Feature | SecureCollab | Notion | Google Docs | Obsidian | Signal |
|---------|-------------|--------|-------------|----------|--------|
| E2E Encrypted | ✅ | ❌ | ❌ | ❌ | ✅ |
...
2. Email security@securecollab.app
3. We'll respond within 24 hours
4. See [SECURITY.md](./SECURITY.md) for our responsible disclosure policy
...
-  **Bug Reports**: [GitHub Issues](https://github.com/yourusername/secure-collab/issues)
-  **Discussions**: [GitHub Discussions](https://github.com/yourusername/secure-collab/discussions)
-  **Security**: security@securecollab.app
